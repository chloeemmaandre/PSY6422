...
```{r install and load packages, echo=TRUE, include=FALSE}
...
```{r load the data, echo=TRUE, include=FALSE}
# Load raw data
...
```{r sanity check, echo=TRUE, include=FALSE}
#sanity check 
...
```{r cleaning data, echo=TRUE, include=FALSE}
# Cleaning the data 
