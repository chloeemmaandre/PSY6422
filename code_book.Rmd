...
### **4. Filtered Subsets**
- **Dataset Name**: 'yearly_subcategories' - 'plot_2000', 'plot_2005', 'plot_2010', 'plot_2015', 'plot_2020' 
- **Description**: These datasets are subsets of `plot_data` filtered by specific years.
- **Purpose**: These subsets are combined into `combined_data_year` for visualisation. My first interactive visualisation worked for seperate years but not combined. Seperating the data is the only way I managed to make my interactive visualisation work with all the data. 

---

### **5. Combined Dataset**
- **Dataset Name**: `combined_data_year`
- **Description**: Combines data from 'yearly_subcategories' for visualising smoking prevalence trends across multiple years (2000, 2005, 2010, 2015, and 2020).
- **Key Variables**:
  - `iso_a3`: 3-letter ISO country codes.
  - `Entity`: Country name.
  - `Prevalence`: Percentage of adults who smoke.
